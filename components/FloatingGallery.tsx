...
const photoSets: Photo[][] = [
  [
    { id: "a1", src: "/photo/photo (1).jpg",  w: 400, h: 560, left: "3%",  top: "15%", size: "clamp(175px, 22vw, 358px)", depth: 1.2 },
    { id: "a2", src: "/photo/photo (2).jpg",  w: 500, h: 320, left: "24%", top: "8%", size: "clamp(200px, 26vw, 302px)", depth: 0.9 },
    { id: "a3", src: "/photo/photo (3).jpg",  w: 500, h: 600, left: "60%", top: "13%", size: "clamp(380px, 21vw, 600px)", depth: 1.4 },
    { id: "a4", src: "/photo/photo (4).jpg",  w: 460, h: 300, left: "76%", top: "18%", size: "clamp(188px, 25vw, 392px)", depth: 1.0 },
    { id: "a5", src: "/photo/photo (5).jpg",  w: 300, h: 440, left: "5%",  top: "52%", size: "clamp(150px, 19vw, 302px)", depth: 1.7 },
    { id: "a6", src: "/photo/photo (6).jpg",  w: 480, h: 300, left: "74%", top: "60%", size: "clamp(175px, 22vw, 358px)", depth: 1.1 },
  ],
  [
    { id: "b1", src: "/photo/photo (7).jpg",  w: 420, h: 580, left: "4%",  top: "14%", size: "clamp(163px, 21vw, 336px)", depth: 1.3 },
    { id: "b2", src: "/photo/photo (8).jpg",  w: 520, h: 340, left: "19%", top: "12%", size: "clamp(213px, 28vw, 448px)", depth: 0.8 },
    { id: "b3", src: "/photo/photo (9).jpg", w: 360, h: 520, left: "61%", top: "12%", size: "clamp(150px, 20vw, 314px)", depth: 1.6 },
    { id: "b4", src: "/photo/photo (10).jpg", w: 470, h: 300, left: "77%", top: "17%", size: "clamp(188px, 25vw, 381px)", depth: 1.0 },
    { id: "b5", src: "/photo/photo (11).jpg", w: 300, h: 420, left: "6%",  top: "55%", size: "clamp(144px, 19vw, 291px)", depth: 1.8 },
    { id: "b6", src: "/photo/photo (12).jpg", w: 500, h: 320, left: "75%", top: "62%", size: "clamp(175px, 24vw, 358px)", depth: 1.2 },
  ],
  [
    { id: "c1", src: "/photo/photo (13).jpg", w: 400, h: 560, left: "3%",  top: "16%", size: "clamp(175px, 22vw, 347px)", depth: 1.1 },
    { id: "c2", src: "/photo/photo (14).jpg", w: 540, h: 350, left: "17%", top: "14%", size: "clamp(219px, 29vw, 470px)", depth: 0.7 },
    { id: "c3", src: "/photo/photo (15).jpg", w: 350, h: 510, left: "62%", top: "13%", size: "clamp(156px, 21vw, 325px)", depth: 1.5 },
    { id: "c4", src: "/photo/photo (16).jpg", w: 450, h: 290, left: "78%", top: "19%", size: "clamp(181px, 24vw, 370px)", depth: 1.0 },
    { id: "c5", src: "/photo/photo (17).jpg", w: 310, h: 430, left: "5%",  top: "54%", size: "clamp(144px, 19vw, 286px)", depth: 1.9 },
    { id: "c6", src: "/photo/photo (18).jpg", w: 480, h: 310, left: "75%", top: "58%", size: "clamp(175px, 22vw, 353px)", depth: 1.3 },
  ],
]
